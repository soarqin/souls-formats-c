...
|---|---|---|---|---|---|
| `static readonly Encoding ASCII` | `SFEncoding.cs:13` | static field | `sf_ascii_to_utf8` / `sf_utf8_to_ascii` | `~ partial` | C-style adaptation: imperative functions instead of singleton; Win32 CP1252 |
