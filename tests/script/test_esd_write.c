...
void setUp(void);
void tearDown(void);
void test_esd_write_round_trips_32_bit_fixture(void);
void test_esd_write_round_trips_64_bit_fixture(void);
...
void test_esd_write_round_trips_32_bit_fixture(void) { assert_round_trip(false, 1); }
void test_esd_write_round_trips_64_bit_fixture(void) { assert_round_trip(true, 3); }

int main(void) {
    UNITY_BEGIN();
    RUN_TEST(test_esd_write_round_trips_32_bit_fixture);
    RUN_TEST(test_esd_write_round_trips_64_bit_fixture);
    return UNITY_END();
}
